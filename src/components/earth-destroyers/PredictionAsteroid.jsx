...
export default function PredictionAsteroid() {
	return (
		<article className="flex flex-col items-center absolute right-7 mt-8 w-max z-40">
			...
			<button className="w-24 h-8 flex cursor-pointer active:scale-95 font-roboto items-center gap-2 pl-2.5 bg-slate-400 bg-opacity-20 rounded border border-slate-200">
